...
class OversizedClusterCheckTest {
    ...
    void flagsTooManyWorkers() {
        ClusterInfo cluster = new ClusterInfo("c1", "huge", "RUNNING", "13.3.x", 30, 50L, null, null, null);
    ...
    void passesWithinLimit() {
        ClusterInfo cluster = new ClusterInfo("c1", "normal", "RUNNING", "13.3.x", 30, 4L, null, null, null);
        WorkspaceSnapshot snapshot = new WorkspaceSnapshot(List.of(cluster), List.of(), List.of());
    ...
    void ignoresAutoscalingClustersWithUnknownWorkerCount() {
        ClusterInfo cluster = new ClusterInfo("c1", "autoscale", "RUNNING", "13.3.x", 30, null, null, null, null);
        WorkspaceSnapshot snapshot = new WorkspaceSnapshot(List.of(cluster), List.of(), List.of());
